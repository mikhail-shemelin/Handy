{
  description = "Handy Hybrid - A fork of Handy with local and cloud speech-to-text";
    ...
    in
    {
      packages = forAllSystems (
        ...
        in
        {
          handy = pkgs.rustPlatform.buildRustPackage {
            ...
            meta = {
              description = "A fork of Handy with local and cloud speech-to-text";
              homepage = "https://github.com/mikhail-shemelin/Handy";
              license = lib.licenses.mit;
              mainProgram = "handy-hybrid";
      ...
      nixosModules.default =
        { lib, pkgs, ... }:
        {
          ...
          programs.handyHybrid.package = lib.mkDefault self.packages.${pkgs.stdenv.hostPlatform.system}.handy;
        };
      ...
      homeManagerModules.default =
        { lib, pkgs, ... }:
        {
          ...
          services.handyHybrid.package = lib.mkDefault self.packages.${pkgs.stdenv.hostPlatform.system}.handy;
        };
      ...
      devShells = forAllSystems (
        ...
        in
        {
          default = pkgs.mkShell {
            ...
            shellHook = ''
              echo "Handy Hybrid development environment"
              bun install
