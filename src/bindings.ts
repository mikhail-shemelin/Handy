...
async changeOpenaiTranscriptionEnabledSetting(enabled: boolean) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_openai_transcription_enabled_setting", { enabled }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async changeOpenaiTranscriptionBaseUrlSetting(baseUrl: string) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_openai_transcription_base_url_setting", { baseUrl }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async changeOpenaiTranscriptionApiKeySetting(apiKey: string) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_openai_transcription_api_key_setting", { apiKey }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async changeOpenaiTranscriptionModelSetting(model: string) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_openai_transcription_model_setting", { model }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async changeOpenaiTranscriptionPromptSetting(prompt: string) : Promise<void> {
    await TAURI_INVOKE("change_openai_transcription_prompt_setting", { prompt });
},
async changeOpenaiTranscriptionChunkingEnabledSetting(enabled: boolean) : Promise<void> {
    await TAURI_INVOKE("change_openai_transcription_chunking_enabled_setting", { enabled });
},
...
async autoSelectLocalModelIfActiveRouteIsLocal(modelId: string) : Promise<Result<boolean, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("auto_select_local_model_if_active_route_is_local", { modelId }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
...
export type PasteMethod = "ctrl_v" | "direct" | "none" | "ctrl_shift_v" | "external_script"
