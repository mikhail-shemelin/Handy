      ...
      <div className="text-sm text-gray-600 space-y-2">
        <div>
          ...
          <span className="font-mono text-xs select-text">
            %APPDATA%/com.mikhail-shemelin.handy-hybrid
          </span>
        </div>
        <div>
          <span className="font-medium">
          ...
          {/* eslint-disable-next-line i18next/no-literal-string */}
          <span className="font-mono text-xs select-text">
            %APPDATA%/com.mikhail-shemelin.handy-hybrid/models
          </span>
        </div>
        <div>
          <span className="font-medium">
          ...
          {/* eslint-disable-next-line i18next/no-literal-string */}
          <span className="font-mono text-xs select-text">
            %APPDATA%/com.mikhail-shemelin.handy-hybrid/settings_store.json
          </span>
        </div>
      </div>
    </SettingContainer>
